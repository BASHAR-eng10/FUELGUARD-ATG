...
"[project]/frontend/.next-internal/server/app/api/stations/[id]/tanks/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/frontend/src/app/api/stations/[id]/tanks/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const tanks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$auth$2f$tokenManager$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeAuthenticatedExternalRequest"])(user.userId.toString(), '/ak4tek/tanks/');
        ...
        const filteredTanks = tanks.data?.filter((tank)=>{
            const station = stations.data.find((s)=>s.EWURALicenseNo === tank.EWURALicenseNo);
        ...
        const latestTanks = filteredTanks.reduce((acc, tank)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__564d63e8._.js.map