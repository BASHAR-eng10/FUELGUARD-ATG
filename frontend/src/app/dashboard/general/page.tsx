...
export default function GeneralDashboard() {
  ...
  const alerts = [
    { type: 'Water Detection', station: 'Main Street', severity: 'high', time: '2 hours ago', color: '#dc2626' },
    { type: 'Cash Discrepancy', station: 'Highway Junction', severity: 'medium', time: '4 hours ago', color: '#eab308' },
        ...
        <div style={styles.metricsGrid}>
          ...
          >
            <div style={styles.metricHeader}>
              ...
              <span style={{...styles.statusBadge, color: '#166534', backgroundColor: '#dcfce7'}}>Active</span>
            </div>
            <h3 style={styles.metricValue}>{loading ? '-' : stations.length}</h3>
          ...
          >
            <div style={styles.metricHeader}>
              ...
              <span style={{...styles.statusBadge, color: '#dc2626', backgroundColor: '#fee2e2'}}>Urgent</span>
            </div>
            <h3 style={styles.metricValue}>2</h3>
            <p style={styles.metricLabel}>Active Alerts</p>
            <div style={styles.metricFooter}>
              <AlertTriangle size={12} color="#dc2626" style={{marginRight: '4px'}} />
              Requires attention
            </div>
          </div>
        </div>
    ...
    {malerts.map((alertItem, index) => (
      ...
      >
        <div style={styles.alertInfo}>
          <div style={{...styles.alertDot, backgroundColor: alertItem.type == "high" ? '#dc2626' : '#fbbf24'}}></div>
          ...
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            {loading ? (
              <div style={{
                ...
                <Loader2 size={24} style={{marginRight: '8px', animation: 'spin 1s linear infinite'}} />
                ...
                {stations.map((station) => (
                  ...
                  >
                    <div style={styles.stationInfo}>
                      <div style={{...styles.stationIcon, backgroundColor: `${station.color}20`}}>
                      ...
                      <div style={styles.stationDetails}>
                        ...
                        {station.operatorName && (
                          <p style={{...styles.stationLocation, color: '#9ca3af', fontSize: '11px'}}>
                    ...
                    <div style={styles.stationMetrics}>
                      <div style={styles.stationMetric}>
                        <p style={styles.stationMetricValue}>{station.efficiency}%</p>
                        <p style={styles.stationMetricLabel}>Efficiency</p>
                      </div>
                      <div style={styles.stationMetric}>
                        <p style={styles.stationMetricValue}>{station.revenue}</p>
                      ...
                      <div style={styles.stationMetric}>
                        <p style={styles.stationMetricValue}>{station.nozzles}</p>
                        <p style={styles.stationMetricLabel}>Nozzles</p>
                      </div>
                      {station.alerts > 0 && (
                        <div style={styles.stationMetric}>
                          <p style={{...styles.stationMetricValue, color: '#dc2626'}}>{station.alerts}</p>
                          <p style={styles.stationMetricLabel}>Alerts</p>
                        </div>
                      )}
                      <div style={{...styles.statusIndicator, backgroundColor: station.color}}></div>
                    </div>
                  </div>
                ))}
              </div>
